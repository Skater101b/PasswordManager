...
class DialogWidget(Tkinter.Tk):
    ...
    def __init__(self,parent, UnamePword):
        ...
        Tkinter.Tk.geometry(self, "300x200+300+600")
...
class PSWUI(Tkinter.Tk, Text): # I call Tkinter.tk as the master since it's inherited in this class
    ...
    def __init__(self,parent): 
        Tkinter.Tk.__init__(self,parent) 
        Tkinter.Tk.geometry(self, "800x400+600+500")
    ...
    def initialize(self):
       ...
       # This builds the tabs and gives them titles. 
        ...
        self.label20 = Tkinter.Label(self.tab1, text="Helvetica", font=("Helvetica", 16),textvariable=self.labelVariable10,
                              anchor="w",fg="white",bg="black")
        self.label20.grid(column=0,row=0,columnspan=1,sticky='EW')
        self.labelVariable10.set("Enter a Name")
        
        self.labelVariable11 = Tkinter.StringVar()
        self.label21 = Tkinter.Label(self.tab1, text="Helvetica", font=("Helvetica", 16), textvariable=self.labelVariable11,
                              anchor="w",fg="white",bg="black")
        self.label21.grid(column=0,row=1,columnspan=1,sticky='EW')
        self.labelVariable11.set("Enter a UserName")
        
        self.labelVariable12 = Tkinter.StringVar()
        self.label22 = Tkinter.Label(self.tab1, text="Helvetica", font=("Helvetica", 16),textvariable=self.labelVariable12,
                              anchor="w",fg="white",bg="black")
        self.label22.grid(column=0,row=2,columnspan=1,sticky='EW')
        self.labelVariable12.set("Enter a Password")
        
        self.labelVariable14 = Tkinter.StringVar()
        self.label23 = Tkinter.Label(self.tab1, text="Helvetica", font=("Helvetica", 16),textvariable=self.labelVariable14,
                              anchor="w",fg="white",bg="black")
        self.label23.grid(column=0,row=5,columnspan=1,sticky='EW')
        self.labelVariable14.set("Enter A Counter")
        
        self.labelVariable15 = Tkinter.StringVar()
        self.label24 = Tkinter.Label(self.tab1, text="Helvetica", font=("Helvetica", 16),textvariable=self.labelVariable15,
                              anchor="w",fg="white",bg="black")
        self.label24.grid(column=0,row=4,columnspan=1,sticky='EW')
        self.labelVariable15.set("PSW Expires? ")
        
        lst1 = ['Yes','No']
        self.var1 = Tkinter.StringVar()
        drop = Tkinter.OptionMenu(self.tab1 ,self.var1, *lst1)
        drop.grid(column=1, row=4, sticky='EW')
        
        self.entryVariable14 = Tkinter.StringVar()
        self.entry14 = Tkinter.Entry(self.tab1, text="Helvetica", font=("Helvetica", 16), textvariable=self.entryVariable14)
        self.entry14.grid(column=1, row=5, sticky='EW')
        ...
        self.entry10.grid(column=1,row=0,sticky='EW')
        ...
        self.entry11.grid(column=1,row=1,sticky='EW')
        ...
        self.entry12.grid(column=1,row=2,sticky='EW')   
        ...
        self.label13.grid(column=0,row=6,columnspan=4,sticky='EW')
        self.labelVariable13.set(u"Description: ")
        
        self.Dtext = Tkinter.Text(self.tab1)
        self.Dtext.grid(column=0,row=6,columnspan=4,sticky='EW')
        ...
        self.userListBoxtab3.grid(column=0, row=1, columnspan=1, sticky='EW')
        self.resultsExpire = Expires()
        print self.resultsExpire
    ...
    def onTabChange(self,event) :
        ...
        A = self.note.index(self.note.select())  # Gets tab by 1, 0 or 2 depending on tab selected.
        if A == 1 :
