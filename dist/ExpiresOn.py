        ...
        for element in dataStack:
            if element['Six'] != "" :
                ...
                if compareDate >= timeObject:
                    tenDays += (element['ONE'] + "_" +  element['Six'] + "._Expires_in_less_than_ten_days. ")
                elif compareDate == timeObject :
                    tenDays += (element['ONE'] + "_" +  element['Six'] + "._Expired_already_or_does_Today. ")
                else :
                    pass
    tenDays += "No_other_passwords_to_expire."
    return tenDays       
